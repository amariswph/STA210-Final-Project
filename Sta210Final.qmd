...
![](Variables%20Intro.png){width="551"}
...
```{r, message = F, warning = F, echo = F, fig.width= 4, fig.height= 4}
...
```{r, fig.width= 8, fig.height= 6, message = F, warning = F, echo = F}
...
grid.arrange(plot6, plot7, ncol = 2, top = "Numeric Predictors'Relationships with Demeanor Category", heights = c(2, 2))
```
